  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local function on_attach(client, bufnr)
        ...
        -- Add any additional logic specific to roslyn.nvim if needed
      end
...
--
-- vim.fs.joinpath(vim.fn.stdpath 'data'--[[@as string]], 'roslyn')
-- vim.fs.joinpath(vim.fn.stdpath 'data', 'roslyn')
-- print(vim.fn.stdpath 'data')
-- print(vim.fs)
-- print(vim.fs.joinpath)
-- vim.fs.joinpath('C:\\Users\\silas\\AppData\\Local\\nvim-data', 'lazy')
